...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _login(){
    if(_formkey.currentState?.validate() ?? false){
      ...
      if(emailController.text == 'Bora@gmail.com' && passwordController == 'Bora@1234'){
        ...
        showDialog(context: context, builder: (context)=>AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text("Login Failed", style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w500),),
              SizedBox(height: 12,),
              Lottie.asset('assets/lottie/wrong.json', width: 200),
              SizedBox(height: 12,),
